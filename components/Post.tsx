            ...
            >
              <View style={styles.postHeader}>
                ...
                >
                  ...
                  >
                    {/* First check if post has stored avatar data */}
                    {post.avatar ? (
                      // Post has stored avatar (could be NFT URL or emoji)
                      ...
                      // This is current user's post - show their current avatar
                      currentUserNFTAvatar ? (
                        <Image 
                      ...
                      // Other users' posts - show wallet initials as fallback
                      <Text style={[styles.avatarText, { color: isDarkMode ? '#000' : '#fff' }]}>
                        {post.wallet.slice(0, 2)}
                      </Text>
                    )}
