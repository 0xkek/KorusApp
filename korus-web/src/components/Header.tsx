          ...
          <div className="flex items-center gap-4">
            {connected && (
              <button
                ...
                className="w-10 h-10 rounded-full bg-gradient-to-br from-korus-primary to-korus-secondary flex items-center justify-center text-black font-bold border-2 border-korus-primary/50 hover:scale-110 transition-transform flex-shrink-0"
              >
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            {connected && onSettingsClick && (
              <button
                ...
                className="w-10 h-10 rounded-full bg-gradient-to-br from-korus-primary/20 to-korus-secondary/20 flex items-center justify-center hover:scale-110 transition-transform border border-korus-primary/30"
              >
