...
export default function PremiumUpgradeModal({ isOpen, onClose, onUpgrade, onSuccess, onSubscriptionUpdated }: PremiumUpgradeModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-[#1e1e1e] border border-white/[0.06] rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4"
          ...
          {isPremium ? (
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full px-4 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 white-text rounded-lg hover:shadow-lg font-semibold duration-150 border border-white/[0.06] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isProcessing ? (
              ...
              <button
                ...
                disabled={isProcessing}
                className="w-full px-4 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 white-text rounded-lg hover:shadow-lg font-semibold duration-150 relative border border-white/[0.06] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {!isProcessing && (
