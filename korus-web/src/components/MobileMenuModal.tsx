...
export default function MobileMenuModal({ isOpen, onClose, onNotificationsToggle }: MobileMenuModalProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div ref={modalRef} className="modal-content fixed top-0 left-0 bottom-0 w-80 bg-[#1e1e1e] border-r border-[#1a1a1a] z-50 md:hidden overflow-y-auto">
        {/* Header */}
        ...
        <div className="p-4 border-t border-[#1a1a1a]">
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 p-3 bg-white/[0.06] border border-[#1a1a1a] rounded-lg text-[#a1a1a1] hover:bg-white/[0.12] hover:text-[#fafafa] transition-all duration-150"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
