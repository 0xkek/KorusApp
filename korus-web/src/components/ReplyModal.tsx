...
export default function ReplyModal({ isOpen, onClose, post, onReplySuccess }: ReplyModalProps) {
  ...
  return (
    <div className="modal-backdrop fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div ref={modalRef} className="modal-content bg-[#1e1e1e] border border-white/10 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
        <div className="sticky top-0 bg-[#1e1e1e] backdrop-blur-md flex items-center justify-between p-6 border-b border-white/10">
        ...
        <div className="p-6 border-b border-white/10">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              {post.image && (
                <div className="mb-3 rounded-2xl overflow-hidden border border-white/10 w-2/3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between mt-4">
                <div className="flex items-center gap-2">
                  {/* Media Upload */}
                  <label className="flex items-center justify-center w-10 h-10 bg-white/[0.06] backdrop-blur-sm border border-white/15 rounded-xl text-korus-primary hover:bg-white/[0.12] hover:border-white/10 transition-all duration-150 hover:shadow-lg hover:shadow-korus-primary/10 cursor-pointer">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showGifPicker && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4" onClick={() => setShowGifPicker(false)}>
          <div className="bg-[#1e1e1e] border border-white/10 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between p-4 border-b border-white/10">
