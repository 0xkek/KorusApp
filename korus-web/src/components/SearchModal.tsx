  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/60 backdrop-blur-sm overflow-y-auto pt-20 pb-20">
      <div ref={modalRef} className="relative w-full max-w-2xl mx-4">
        <div className="bg-[#1e1e1e] border border-[#1a1a1a] rounded-2xl shadow-2xl overflow-hidden">
          {/* Header */}
          ...
          <div className="p-6 border-b border-[#1a1a1a]">
            <form onSubmit={handleSubmit}>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-24 py-3 bg-white/[0.06] border border-[#1a1a1a] rounded-lg text-[#fafafa] placeholder-neutral-600 focus:border-korus-primary/50 focus:ring-1 focus:ring-korus-primary/20 outline-none transition-all"
                />
                {searchQuery && (
            ...
            {showHistory && searchHistory.length > 0 && (
              <div className="mt-3 p-3 bg-white/[0.06] border border-[#1a1a1a] rounded-lg">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-sm font-semibold whitespace-nowrap transition-all ${
                    (category === 'All' && !selectedCategory) || selectedCategory === category.toLowerCase()
                      ...
                      : 'bg-white/[0.06] text-[#a1a1a1] border border-[#1a1a1a] hover:bg-white/[0.12]'
                  }`}
                >
                  {category}
                </button>
          ...
          <div className="max-h-[60vh] overflow-y-auto">
            {/* Search Info */}
            <div className="px-6 py-3 bg-white/[0.04] border-b border-[#1a1a1a]">
