...
export default function CreatePostModal({ isOpen, onClose, initialContent = '', onPostCreate, queueInfo }: CreatePostModalProps) {
  ...
  return (
    ...
    >
      <div ref={modalRef} className="modal-content bg-[#1e1e1e] border border-[#222222] rounded-2xl shadow-2xl max-w-2xl w-full">
        {/* Modal Header */}
                  ...
                  {selectedFiles.map((file, index) => (
                    <div key={index} className="relative group">
                      {file.type.startsWith('image/') ? (
                        ...
                        <div className="w-full h-32 bg-white/[0.06] border border-[#222222] rounded-xl flex items-center justify-center">
              ...
              <div className="flex items-center justify-between mt-4">
                <div className="flex items-center gap-2">
                  ...
                  <label
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-white/[0.06] backdrop-blur-sm border border-[#2a2a2a] rounded-xl text-korus-primary hover:bg-white/[0.12] hover:border-[#222222] transition-all duration-150 hover:shadow-lg hover:shadow-korus-primary/10 cursor-pointer"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    aria-label="Add GIF"
                    className="flex items-center justify-center w-10 h-10 bg-white/[0.06] backdrop-blur-sm border border-[#2a2a2a] rounded-xl text-korus-primary hover:bg-white/[0.12] hover:border-[#222222] transition-all duration-150 hover:shadow-lg hover:shadow-korus-primary/10"
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center w-10 h-10 backdrop-blur-sm border rounded-xl transition-all duration-150 hover:shadow-lg hover:shadow-korus-primary/10 ${
                      showEmojiPicker
                        ...
                        : 'bg-white/[0.06] border-[#2a2a2a] text-korus-primary hover:bg-white/[0.12] hover:border-[#222222]'
                    }`}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 backdrop-blur-sm border rounded-xl transition-all duration-150 ${
                      content.trim() || selectedFiles.length > 0
                        ? 'bg-white/[0.06] border-[#2a2a2a] text-korus-primary hover:bg-white/[0.12] hover:border-[#222222] hover:shadow-lg hover:shadow-korus-primary/10 cursor-pointer'
      ...
      {showEmojiPicker && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] flex items-center justify-center p-4">
          <div className="bg-[#1e1e1e] border border-[#222222] rounded-2xl shadow-2xl max-w-md w-full max-h-[80vh] overflow-hidden">
            {/* Header */}
