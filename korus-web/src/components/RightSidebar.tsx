  ...
  return (
    <div className="sticky top-0 h-screen w-[320px] shrink-0 z-30 py-[24px] px-[20px] hidden lg:flex flex-col overflow-y-auto">
      ...
      {showNotifications ? (
        ...
        <div className="bg-[#171717] rounded-xl border border-[#2a2a2a] p-[16px] mb-[16px]">
          ...
          <div role="list" aria-label="Notifications">
            {isLoading ? (
              <div className="text-center py-8 text-[#525252]">
                <div className="w-6 h-6 border-2 border-[#2a2a2a] border-t-white/40 rounded-full animate-spin mx-auto mb-2"></div>
