...
export function GamesPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default: return 'border-[#222222] bg-white/[0.06] text-[#a1a1a1]';
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 pb-24">
      ...
      {activeTab === 'lobby' && (
        ...
        <div className="space-y-0">
          {games.map((game) => (
            <div
              key={game.id}
              className="border-b border-[#222222] bg-white/[0.04]"
            >
              ...
              {expandedGameId === game.id && (
                <div className="px-6 pb-3 bg-[#171717] border-t border-[#222222]">
                  <div className="py-3">
            ...
            <div className="space-y-0">
              {completedGames.map((game) => {
                ...
                return (
                  <div
                    key={game.id}
                    className="border-b border-[#222222] bg-white/[0.04] hover:bg-white/[0.06] duration-150 cursor-pointer"
                        ...
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <button
                              ...
                              className="bg-[#171717] border border-[#222222] text-[#fafafa] font-bold px-3 py-1 rounded-full hover:bg-[#171717] duration-150 text-xs"
                            >
      ...
      {showCreateModal && typeof window !== 'undefined' && createPortal(
        ...
        >
          <div
            className="bg-[#1e1e1e] border border-[#222222] rounded-2xl shadow-2xl p-8 max-w-lg w-full"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
                  ...
                  <button
                    ...
                    className={`p-3 rounded-lg border-2 duration-150 ${
                      newGame.type === gameType.id
                        ...
                        : 'border-[#222222] bg-white/[0.06] text-[#a1a1a1] hover:border-korus-primary/50'
            ...
            <div className="mb-6">
              ...
              <input
                ...
                disabled={isProcessing}
                className="w-full px-4 py-2 bg-white/[0.06] border border-[#2a2a2a] rounded-lg text-[#fafafa] focus:border-korus-primary focus:outline-none disabled:opacity-50 duration-150"
                placeholder="0.1"
              />
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setShowCreateModal(false)}
                disabled={isProcessing}
                className="flex-1 bg-white/[0.06] border border-[#222222] text-[#fafafa] font-semibold py-3 rounded-lg hover:bg-white/[0.08] duration-150 disabled:opacity-50"
              >
                Cancel
              </button>
              <button
      ...
      {showCancelModal && gameToCancelData && typeof window !== 'undefined' && createPortal(
        ...
        >
          <div
            className={`bg-[#1e1e1e] border border-[#222222] rounded-2xl shadow-2xl p-8 max-w-md w-full duration-150 duration-150 ${
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-white/[0.06] border border-[#222222] text-[#fafafa] font-semibold py-3 rounded-lg hover:bg-white/[0.08] duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Keep Game
              </button>
              <button
