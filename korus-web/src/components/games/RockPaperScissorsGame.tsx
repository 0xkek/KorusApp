      ...
      <div className="flex items-center justify-between mb-2 px-2 text-xs">
        ...
        {!isGameOver && timeLeft && (
          <div className="flex items-center gap-1.5 relative">
            ...
            {showTimerInfo && (
              <div className="absolute top-6 right-0 bg-[#141414] border border-[#1a1a1a] rounded-lg p-2 w-48 text-xs shadow-lg z-10">
          ...
          <button
            ...
            className={`
              ...
              ${playerMove === choice.id
                ...
                : 'bg-gradient-to-br from-[#141414] to-[#141414] border-2 border-[#1a1a1a] hover:border-korus-primary/50 hover:scale-105'
              }
