...
export default function TipModal({ isOpen, onClose, recipientUser, postId, onTipSuccess }: TipModalProps) {
  ...
  return (
    <div className="modal-backdrop fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={(e) => { if (e.target === e.currentTarget && !isSending) onClose(); }}>
      <div ref={modalRef} className="modal-content bg-[#1e1e1e] border border-white/[0.06] rounded-2xl shadow-2xl max-w-md w-full">
        {/* Modal Header */}
        ...
        {showSuccessScreen ? (
          ...
          <div className="p-8 text-center">
            ...
            <div className="bg-white/[0.06] border border-white/15 rounded-lg p-4 mb-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.0"
                className="w-full bg-white/[0.06] text-[#fafafa] text-lg font-medium pl-4 pr-16 py-3 rounded-lg border border-white/15 focus:border-korus-primary/50 focus:ring-1 focus:ring-korus-primary/20 outline-none transition-colors"
