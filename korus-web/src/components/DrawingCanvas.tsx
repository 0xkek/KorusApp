...
export default function DrawingCanvas({ isOpen, onClose, onSave }: DrawingCanvasProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div ref={modalRef} className="bg-[#171717] backdrop-blur-md rounded-2xl max-w-6xl w-full border border-[#2a2a2a] shadow-xl overflow-hidden">
        {/* Header */}
          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col gap-4 w-48">
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className="px-3 py-2 bg-white/[0.06] border border-[#2a2a2a] rounded-lg text-white text-sm hover:bg-white/[0.12] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  ↶ Undo
                </button>
                <button
                ...
                <button
                  onClick={clearCanvas}
                  className="px-3 py-2 bg-white/[0.06] border border-[#2a2a2a] rounded-lg text-white text-sm hover:bg-white/[0.12] transition-all"
                >
                  🗑️ Clear
                </button>
              </div>
            ...
            <div className="flex-1">
              <canvas
                ...
                className="border-2 border-[#2a2a2a] rounded-xl cursor-crosshair bg-white w-full"
