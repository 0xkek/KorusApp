...
export default function DrawingCanvas({ isOpen, onClose, onSave }: DrawingCanvasProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div ref={modalRef} className="bg-korus-surface/95 backdrop-blur-md rounded-2xl max-w-6xl w-full border border-korus-border shadow-xl overflow-hidden">
        {/* Header */}
          ...
          <div className="flex gap-6">
            ...
            <div className="flex flex-col gap-4 w-48">
                    ...
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg border-2 transition-all ${
                        currentColor === color
                          ...
                          : 'border-korus-border hover:scale-105'
                      }`}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full"
                />
                <div className="text-korus-textSecondary text-xs text-center mt-1">{brushSize}px</div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className="px-3 py-2 bg-korus-surface/40 border border-korus-borderLight rounded-lg text-white text-sm hover:bg-korus-surface/60 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  ↶ Undo
                </button>
                <button
                ...
                <button
                  onClick={clearCanvas}
                  className="px-3 py-2 bg-korus-surface/40 border border-korus-borderLight rounded-lg text-white text-sm hover:bg-korus-surface/60 transition-all"
                >
                  🗑️ Clear
                </button>
              </div>
            ...
            <div className="flex-1">
              <canvas
                ...
                className="border-2 border-korus-border rounded-xl cursor-crosshair bg-white w-full"
