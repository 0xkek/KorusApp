    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--color-surface)]">
          <div className="max-w-md w-full bg-[var(--color-surface)] backdrop-blur-xl rounded-2xl border border-[var(--color-border-light)] p-8 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mt-6 text-left">
                ...
                <pre className="mt-2 p-3 bg-[var(--color-surface)] rounded text-xs text-red-400 overflow-auto max-h-48">
