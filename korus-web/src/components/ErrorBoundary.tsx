    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-[#1e1e1e]">
          <div className="max-w-md w-full bg-[#171717] backdrop-blur-xl rounded-2xl border border-white/[0.06] p-8 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mt-6 text-left">
                <summary className="text-sm text-[#a1a1a1] cursor-pointer hover:text-[#fafafa]">
                  Error Details (Dev Only)
                </summary>
                <pre className="mt-2 p-3 bg-[#1e1e1e] rounded text-xs text-red-400 overflow-auto max-h-48">
