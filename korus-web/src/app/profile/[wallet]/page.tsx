            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                    ...
                    <div className="mb-3">
                      <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold ${
                        userInfo.isPremium
                          ...
                          : 'bg-white/[0.06] text-[#a1a1a1] border border-[#1a1a1a]'
                      }`}>
                        {userInfo.isPremium ? (
                          <>
                ...
                <div className="flex gap-2 mb-6">
                  <div className="flex-1 bg-white/[0.04] backdrop-blur-sm border border-[#1a1a1a] rounded-2xl p-4">
                    <div className="text-center">
                ...
                {/* Privacy Notice */}
                <div className="text-center py-16 bg-white/[0.04] backdrop-blur-sm border border-[#1a1a1a] rounded-2xl">
