    ...
    <main className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
          ...
          <div className="flex-1 min-w-0 border-x border-[#1a1a1a]">
            ...
            <div className="p-6">
              ...
              <div className="mb-8 relative">
                ...
                <div className="mb-6 bg-white/[0.04] backdrop-blur-sm border border-[#1a1a1a] rounded-2xl p-6 relative z-50">
                  <h3 className="text-lg font-bold text-[#fafafa] mb-4">Your Identity</h3>

                  {/* Current Display Name */}
                  <div className="mb-6 p-4 bg-white/[0.06] border border-[#1a1a1a] rounded-xl">
                    ...
                    <div className="mb-4">
                      ...
                      {!editingUsername ? (
                        <button
                          ...
                          className="w-full bg-white/[0.06] border border-[#1a1a1a] rounded-xl p-4 hover:border-[#1a1a1a] transition-colors"
                        >
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-3">
                            <button
                              ...
                              className="flex-1 px-4 py-2 bg-white/[0.08] border border-[#1a1a1a] text-[#fafafa] rounded-lg hover:bg-white/[0.12] duration-150"
                            >
                              Cancel
                            </button>
                            <button
                  ...
                  {isPremium && allSNSDomains.length > 0 && (
                    <div className="relative z-[100]">
                      ...
                      <div className="relative z-50" ref={snsDropdownRef}>
                        ...
                        {/* SNS Dropdown */}
                        {showSNSDropdown && (
                          <div className="absolute top-full left-0 right-0 mt-2 bg-[#141414] backdrop-blur-xl border border-[#1a1a1a] rounded-xl z-50 max-h-60 overflow-y-auto">
                            {allSNSDomains.map((domain, index) => (
                              <button
                                ...
                                className="w-full px-4 py-3 text-left hover:bg-korus-primary/20 hover:border-korus-primary/40 transition-colors border-b border-[#1a1a1a] last:border-b-0 cursor-pointer"
                              >
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-3">
                ...
                {/* Tabs */}
                <div className="bg-[#141414] border border-[#1a1a1a] rounded-xl mb-6 relative z-10">
                  <div className="flex">
                    <button
                ...
                <div className="bg-white/[0.04] backdrop-blur-sm border border-[#1a1a1a] rounded-2xl p-6 mb-6">
                  ...
                  {isPremium && (
                    <div className="flex items-center justify-center gap-2 mt-4 pt-4 border-t border-[#1a1a1a]/30">
              ...
              <div className="space-y-4">
                {userPosts.length === 0 ? (
                  <div className="text-center py-20 bg-white/[0.04] backdrop-blur-sm border border-[#1a1a1a] rounded-2xl">
                    {activeTab === 'posts' ? (
                      <>
                  ...
                  userPosts.map((post) => (
                    <div key={post.id} className="bg-white/[0.04] backdrop-blur-sm border border-[#1a1a1a] rounded-2xl p-6 hover:border-[#1a1a1a] transition-all group">
                      <SafeContent
      ...
      {showUsernameWarning && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-[#141414] backdrop-blur-xl border border-[#1a1a1a] rounded-2xl p-6 max-w-md w-full mx-4">
            <div className="text-center">
