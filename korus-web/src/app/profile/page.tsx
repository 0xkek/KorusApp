    ...
    <main className="min-h-screen bg-[#121212] relative overflow-hidden">
          ...
          <div className="flex-1 min-w-0 border-x border-[#2a2a2a]">
            ...
            <div className="p-6">
              ...
              <div className="mb-8 relative">
                    ...
                    <div className="mb-4">
                      ...
                      {!editingUsername ? (
                        <button
                          ...
                          className="w-full bg-white/[0.06] border border-[#2a2a2a] rounded-xl p-4 hover:border-[#2a2a2a] transition-colors"
                        >
                  ...
                  {isPremium && allSNSDomains.length > 0 && (
                    <div className="relative z-[100]">
                      ...
                      <div className="relative z-50" ref={snsDropdownRef}>
                        ...
                        {/* SNS Dropdown */}
                        {showSNSDropdown && (
                          <div className="absolute top-full left-0 right-0 mt-2 bg-[#171717] backdrop-blur-xl border border-[#2a2a2a] rounded-xl z-50 max-h-60 overflow-y-auto">
                ...
                {/* Tabs */}
                <div className="bg-[#171717] border border-[#2a2a2a] rounded-xl mb-6 relative z-10">
                  <div className="flex">
                    <button
              ...
              <div className="space-y-4">
                {userPosts.length === 0 ? (
                  ...
                  userPosts.map((post) => (
                    <div key={post.id} className="bg-white/[0.04] backdrop-blur-sm border border-[#2a2a2a] rounded-2xl p-6 hover:border-[#2a2a2a] transition-all group">
                      <SafeContent
      ...
      {showUsernameWarning && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-[#171717] backdrop-blur-xl border border-[#2a2a2a] rounded-2xl p-6 max-w-md w-full mx-4">
            <div className="text-center">
