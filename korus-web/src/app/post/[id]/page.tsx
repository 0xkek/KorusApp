      ...
      try {
        ...
        if (response) {
          ...
          const transformedPost = {
            ...
            isPremium: backendPost.author?.tier === 'premium' || backendPost.author?.subscriptionStatus === 'active' || !!backendPost.author?.snsUsername,
            ...
            repostedPost: backendPost.isRepost && backendPost.originalPost ? {
              ...
              isPremium: backendPost.originalPost.author?.tier === 'premium' || !!backendPost.originalPost.author?.snsUsername,
            ...
            const transformedReplies = repliesResponse.replies.map(reply => {
              const transformed = {
                ...
                replies: reply.childReplies?.map(child => ({
                  ...
                  isPremium: child.author?.tier === 'premium' || child.author?.subscriptionStatus === 'active' || !!child.author?.snsUsername,
                ...
                isPremium: reply.author?.tier === 'premium' || reply.author?.subscriptionStatus === 'active' || !!reply.author?.snsUsername,
