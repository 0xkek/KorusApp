...
export default function PostDetailPage() {
  ...
  const renderReply = (reply: Reply, level: number = 0) => {
    ...
    return (
      <div key={reply.id}>
        {/* Reply Content */}
        <div className="px-4 py-3 border-b border-white/[0.06] flex gap-3 hover:bg-white/[0.04] transition-colors duration-150">
          {/* Avatar */}
          {reply.avatar ? (
      ...
      <main className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex min-h-screen">
            <div className="flex-1 ml-[260px] mr-[320px] max-w-[640px] border-x border-white/[0.06] xl:ml-[260px] xl:mr-[320px] lg:ml-[240px] lg:mr-[300px] md:ml-[200px] md:mr-0 sm:ml-0 sm:mr-0 max-sm:border-x-0">
              {/* Header skeleton */}
              ...
              <div className="px-4 py-3 animate-pulse">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-5 py-3.5 mt-3.5 border-t border-white/[0.06] border-b border-white/[0.06]">
                      <div className="h-4 w-16 bg-white/[0.06] rounded" />
              ...
              {/* Reply skeletons */}
              {[1, 2].map(i => (
                <div key={i} className="px-4 py-3 animate-pulse border-b border-white/[0.06]">
                  <div className="flex gap-3">
    ...
    <main className="min-h-screen relative overflow-hidden">
          ...
          <div className="flex-1 ml-[260px] mr-[320px] max-w-[640px] border-x border-white/[0.06] xl:ml-[260px] xl:mr-[320px] lg:ml-[240px] lg:mr-[300px] md:ml-[200px] md:mr-0 sm:ml-0 sm:mr-0 max-sm:border-x-0">
            ...
            <div className={`${
              ...
              <div className="p-5">
                ...
                {/* Stats Row */}
                <div className="flex gap-5 py-[14px] mt-[14px] border-t border-white/[0.06] border-b border-white/[0.06]">
                ...
                {/* Post Actions */}
                <div className="flex justify-around py-2 border-b border-white/[0.06]">
                  <button
      ...
      {showEmojiPicker && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowEmojiPicker(false)}>
          <div className="bg-[#171717] backdrop-blur-md rounded-2xl max-w-md w-full max-h-[80vh] border border-white/[0.06] shadow-xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
      ...
      {showGifPicker && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowGifPicker(false)}>
          <div className="bg-[#171717] backdrop-blur-md rounded-2xl max-w-2xl w-full max-h-[80vh] border border-white/[0.06] shadow-xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between p-4 border-b border-white/[0.06]">
