    ...
    <main className="min-h-screen bg-[#121212] relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex min-h-screen max-w-[1280px] mx-auto">
          ...
          <div className="flex-1 min-w-0 border-x border-[#222222]">
            ...
            {/* Header */}
            <div className="sticky top-0 bg-[#171717] backdrop-blur-xl border-b border-[#222222] z-10 p-4">
              <div className="flex items-center gap-4">
                <button
                  onClick={() => router.back()}
                  className="w-10 h-10 bg-white/[0.08] border border-[#2a2a2a] rounded-full flex items-center justify-center text-[#fafafa] font-bold hover:bg-white/[0.12] transition-all duration-150"
                >
                  ←
                </button>
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Premium Section */}
              <div className="bg-[#171717] border border-[#222222] rounded-xl p-6">
                ...
                {isPremium ? (
                  ...
                  <div
                    className="bg-white/[0.04] backdrop-blur-sm border border-[#222222] rounded-xl p-4"
                    style={{
                ...
                <div className="mt-4 p-4 bg-white/[0.04] rounded-xl border border-[#222222]">
              ...
              <div className="bg-[#171717] border border-[#222222] rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Dark Mode */}
                  <div className="flex items-center justify-between p-4 bg-white/[0.04] rounded-xl border border-[#222222]">
                    <div>
                  ...
                  {/* Color Theme */}
                  <div className="p-4 bg-white/[0.04] rounded-xl border border-[#222222]">
              ...
              <div className="bg-[#171717] border border-[#222222] rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="flex items-center justify-between p-4 bg-white/[0.04] rounded-xl border border-[#222222] hover:bg-white/[0.06] transition-all duration-150 w-full"
                  >
              ...
              <div className="bg-[#171717] border border-[#222222] rounded-xl p-6">
                ...
                <button
                  ...
                  className="flex items-center justify-between p-4 bg-white/[0.04] rounded-xl border border-[#222222] hover:bg-red-500/20 transition-all duration-150 w-full"
                >
                  <div className="flex items-center gap-3">
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-[#1e1e1e] backdrop-blur-xl border border-[#222222] rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4">
      ...
      {showFAQModal && (
        ...
        >
          <div
            className="bg-[#1e1e1e] backdrop-blur-xl border border-[#222222] rounded-2xl shadow-2xl p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto"
