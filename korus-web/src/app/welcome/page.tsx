    ...
    <main className="min-h-screen bg-gradient-to-b from-[#121212] via-[#121212] to-[#121212] relative overflow-hidden">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed top-4 right-4 z-50">
          ...
          {showDeveloperTools && (
            <div className="absolute top-8 right-0 bg-[#121212] border border-[#2a2a2a] rounded p-3 text-xs text-[#fafafa] font-mono min-w-48">
      ...
      <div className="relative z-10">
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="max-w-2xl w-full text-center">
            ...
            {/* Connect Wallet Card */}
            <div className="bg-[#171717]/50 border border-[#2a2a2a] rounded-3xl p-10 backdrop-blur-md mb-12 shadow-2xl shadow-black/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-[#171717]/30 border border-[#2a2a2a] rounded-2xl p-8 backdrop-blur-sm hover:bg-[#171717]/50 transition-all">
