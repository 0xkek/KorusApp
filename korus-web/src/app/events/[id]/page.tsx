    ...
    <main className="min-h-screen bg-[#121212] relative overflow-hidden">
        ...
        <div className="flex min-h-screen max-w-[1280px] mx-auto">
          ...
          <div className="flex-1 min-w-0 border-x border-[#222222]">
            ...
            <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
              {/* Event Header */}
              <div className="border border-[#222222] bg-[#171717] rounded-xl overflow-hidden">
                {event.imageUrl && (
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-[#262626] rounded-xl p-4 border border-[#222222]">
              ...
              {!isCreator && (
                <div className="border border-[#222222] bg-[#171717] rounded-xl p-6">
                  ...
                  {!connected ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full py-4 bg-gradient-to-r from-korus-primary to-korus-secondary text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-korus-primary/20 duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isRegistering ? (
      ...
      {showCancelModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1e1e1e] border border-[#222222] rounded-2xl shadow-2xl max-w-md w-full">
            <div className="p-6">
              {/* Warning Icon */}
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isCancelling}
                  className="flex-1 px-4 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 duration-150 font-semibold disabled:opacity-50"
                >
                  {isCancelling ? (
                    <div className="flex items-center justify-center gap-2">
