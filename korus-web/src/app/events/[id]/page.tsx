            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-white/[0.08] border border-white/15 text-[#fafafa] font-semibold rounded-lg hover:bg-white/[0.12] duration-150 disabled:opacity-50"
                >
                  Keep Event
                </button>
                <button
